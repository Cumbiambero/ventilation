...
#define PIN_DHT_SENSOR_POWER 6 // pin for powering the temperature and humidity sensor
#define PIN_RELAY_FOR_FAN 7    // pin for the relay control that powers the 12v fan
